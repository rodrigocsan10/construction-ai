...
wall_lf_overrides.example.json
  Template for your own LF overrides (copy and edit paths/tags).

Replace sample numbers with quantities from your field measure or plan takeoff before bidding.
